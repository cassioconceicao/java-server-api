 ...
 */
public class TimestampFormatter extends JFormattedTextField.AbstractFormatter {

    private int length = 12;
    private String mask = "##/##/#### ##:##";
    private static final DateFormat DTF = DateFormat.getDateTimeInstance(DateFormat.DEFAULT, DateFormat.SHORT, new Locale("pt", "BR"));
    ...
    public Object stringToValue(String text) throws ParseException {
        ...
        return new java.sql.Timestamp(DTF.parse(text).getTime());
    }
